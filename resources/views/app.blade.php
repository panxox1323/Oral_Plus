		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav">
                    ...
                    <li><a href="{{ route('admin.users.index') }}"><span class="icon-user"></span> Usuario</a></li>
                    <li><a href="{{ route('admin.especialistas.index') }}"><span class="icon-health"> Especialista</span></a></li>
                    <li><a href=""><span class="icon-loop2"> Insumo</span></a></li>
				</ul>
